...
# Print summaries for one set (e.g., 30-day)
cat("\n####################################\n")
cat("\n=== UNIVARIATE MODELS FOR 30-DAY ===\n")
cat("\n####################################\n")
for (var in names(univariate_models_30)) {
  cat("\n----------------------------\n")
  cat("Summary for:", var, "\n")
  cat("----------------------------\n")
  print(summary(univariate_models_30[[var]]))
}

# Print summaries for one set (e.g., 60-day)
cat("\n####################################\n")
cat("\n=== UNIVARIATE MODELS FOR 60-DAY ===\n")
cat("\n####################################\n")
for (var in names(univariate_models_60)) {
  cat("\n----------------------------\n")
  cat("Summary for:", var, "\n")
  cat("----------------------------\n")
  print(summary(univariate_models_60[[var]]))
}

# Print summaries for one set (e.g., 90-day)
cat("\n####################################\n")
cat("\n=== UNIVARIATE MODELS FOR 90-DAY ===\n")
cat("\n####################################\n")
for (var in names(univariate_models_90)) {
  cat("\n----------------------------\n")
  cat("Summary for:", var, "\n")
  cat("----------------------------\n")
  print(summary(univariate_models_90[[var]]))
}
